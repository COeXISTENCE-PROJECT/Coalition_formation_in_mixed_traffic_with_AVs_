...
les_ax[1].set_title("b) Club is [1,5,6]",**tnrfont,size=19)
les_ax[2].set_title("c) Club is [1,5,6,7]",**tnrfont,size=19)
les_ax[3].set_title("d) Club is [0,1,5,6,7]",**tnrfont,size=19)
les_ax[4].set_title("e) Club is [0,1,5,6]",**tnrfont,size=19)
...
plt.savefig("..\imgs\deviations.png", dpi=400, bbox_inches="tight")
