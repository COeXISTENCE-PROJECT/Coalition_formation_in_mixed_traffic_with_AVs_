...
for tl_0_below_threshold in range(15, 27):      # 30, 31, 32
    for tl_0_above_threshold in range(1, 26):  # 23, 24, 25, 26
...
# Colour palette: high-contrast and colorblind-friendly
col_no_dev = "#009E73"      # bluish green: no one wants to deviate
col_club   = "#E69F00"      # orange: clubs are formed
col_dev    = "#D55E00"      # vermillion/red-orange: some people want to deviate
...
ax.scatter(
    ...
    alpha=0.90,
    zorder=3,
    label=r"Some agents want to deviate"
)
# Labels
ax.set_xlabel(
    r"Initial green time on Route 0",
    **tnrfont,
    size=12
)
